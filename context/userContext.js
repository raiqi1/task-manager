...
export const UserContextProvider = ({ children }) => {
  const serverUrl = "https://task-api-murex.vercel.app";
  ...
  const logoutUser = async () => {
    try {
      const res = await axios.post(
        ...
        {}, // tidak ada data yang dikirim, jadi tetap berikan objek kosong
        {
          withCredentials: true, // mengirim cookies ke server
        }
      );
